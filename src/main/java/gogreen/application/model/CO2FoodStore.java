...
public class CO2FoodStore {
    ...
    /**
     * Makes a CO2FoodStore object with the provided username, weight of the meal,
     * whether the meal is organic or not and the amount of co2 saved.
    ...
    public String toString() {
        return String.format("CO2FoodStore[susername='%s', weight='%s', "
                        + "organic='%s', amountco2='%s']",
    ...
    public void setAmountco2(int amountco2) {
        this.amountco2 = amountco2;
    }
